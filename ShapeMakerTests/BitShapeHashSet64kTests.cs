...
public class BitShapeHashSet64kTests {
    ...
    public void OneByteHashSet() {
        ...
        var bshs = new BitShapeHashSet64k(1);
    ...
    public void TwoByteHashSet() {
        ...
        var bshs = new BitShapeHashSet64k(2);
    ...
    public void ThreeByteHashSet() {
        ...
        var bshs = new BitShapeHashSet64k(3);
    ...
    public void FourByteHashSet() {
        ...
        var bshs = new BitShapeHashSet64k(4);
    ...
    public void FiveByteHashSet() {
        ...
        var bshs = new BitShapeHashSet64k(5);
    ...
    public void SixByteHashSet() {
        ...
        var rs = new HashSet<long>();
        var bshs = new BitShapeHashSet64k(6);
